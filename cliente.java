            ...
            while (true) {
                ...
                switch (opcion) {
                    ...
                    case "7":
                        ...
                        stmt.executeUpdate("UPDATE Transaccion SET estado = 'anulada' WHERE " + "datos_bancarios = '" + datosBancarios + "' AND " + "ubicacion = '" + ubicacion + "' AND " + "fecha = '" + fecha + "' AND " + "recinto_id = '" + recinto + "' AND " + "espectaculo_id = '" + idEspectaculo + "' AND " + "tipo_usuario = '" + tipoUsuario + "'");
